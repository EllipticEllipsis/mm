...
void func_80BCEC6C(EffKamejimaWave* this, PlayState* play) {
    if (Cutscene_CheckActorAction(play, 480)) {
        Cutscene_ActorTranslateAndYaw(&this->actor, play, Cutscene_GetActorActionIndex(play, 480));
        if (play->csCtx.actorActions[Cutscene_GetActorActionIndex(play, 480)]->action == 2) {
...
void func_80BCEDE0(EffKamejimaWave* this, PlayState* play) {
    if (Cutscene_CheckActorAction(play, 502)) {
        Cutscene_ActorTranslateAndYaw(&this->actor, play, Cutscene_GetActorActionIndex(play, 502));
        if (play->csCtx.actorActions[Cutscene_GetActorActionIndex(play, 502)]->action == 2) {
